...
export function ChatPanel({
  ...
  const exampleMessages = [
    ...
    },
    {
      ...
      subheading: 'how to setup a successful business ',
      message: `Please outline how to successfuly develop a business`
    },
    {
      heading: 'Generate an essay',
      subheading: 'with the topic',
      message: `Generate an essay with the topic I will submit below:`
    }
  ]
